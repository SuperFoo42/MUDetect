...
public class ViolationDotExporter {
    ...
    public String toDotGraph(Violation violation) {
        ...
        return new AUGDotExporter(
                ...
                node -> new OverlapNodeAttributeProvider(overlap, "red").getComponentAttributes(node),
                edge -> new OverlapEdgeAttributeProvider(overlap, "red").getComponentAttributes(edge))
    ...
    private String toTargetDotGraph(Overlap instance, APIUsageExample target, Map<String, String> graphAttributes) {
        ...
        return new AUGDotExporter(
                ...
                node -> new OverlapNodeAttributeProvider(instance, "gray").getComponentAttributes(node),
                edge -> new OverlapEdgeAttributeProvider(instance, "gray").getComponentAttributes(edge),
    ...
    public String toTargetEnvironmentDotGraph(Violation violation) {
        ...
        return toTargetDotGraph(overlap, targetEnvironment, new HashMap<String, String>() {{
            put("nslimit", "10000");
        }});
    }
}
